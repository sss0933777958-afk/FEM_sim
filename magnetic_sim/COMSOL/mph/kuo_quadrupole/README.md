...
**相關**：上層 model 索引見 `../README.md`；LiveLink 連線見 `../../../ANSYS/main/reference/workflows/comsol-livelink.md`；mm 座標探測坑見 memory `feedback_comsol_mm_coord_pitfall`；ANSYS 對應設計見 `../../../ANSYS/main/`。
