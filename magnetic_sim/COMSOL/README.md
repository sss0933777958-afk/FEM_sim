...
**相關**：上層磁學類別見 `../README.md`；COMSOL LiveLink headless 連線通用法見 `../ANSYS/main/reference/workflows/comsol-livelink.md`（拆兩 process + `mphstart(2036)`）；各 model 模型清單見 `mph/README.md`。
