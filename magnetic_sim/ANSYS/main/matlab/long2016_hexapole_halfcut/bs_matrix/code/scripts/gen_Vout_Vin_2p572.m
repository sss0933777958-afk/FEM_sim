%% gen_Vout_Vin_2p572.m
%  ------------------------------------------------------------------
%  Compute V_out/V_in 6x6 matrix using sensor placement at 2.572 mm
%  (sensor variant; baseline minus 2.0 mm).
%
...
%
%  Sensor placement (changed: 4.572 -> 2.572 mm; baseline - 2.0 mm):
%      LOWER (P1/P3/P6): pole-local (2.572, 0.41, 0) mm relative to tip
%      UPPER (P2/P4/P5): pole-local decomposition of
%                          2.572 along cone slant + 0.41 outward normal
%                          axial      = 2.572*cos(beta) - 0.41*sin(beta) = 2.4411
%                          transverse = 2.572*sin(beta) + 0.41*cos(beta) = 0.9066
%
...
%
%  Outputs:
%    magnetic_sim/ANSYS/main/MATLAB_data/long2016_hexapole_halfcut/bs_matrix/Vout_Vin_2p572.mat
%    magnetic_sim/ANSYS/main/doc/Solve_B_matrix/long2016_hexapole_halfcut/scripts/Vout_Vin_2p572.tex
%  ------------------------------------------------------------------
...
%% --- Sensor placement: 2.572 mm (CHANGED: baseline - 2.0 mm) ---
S_ALONG  = 2.572e-3;
S_OFFSET = 0.41e-3;
...
fprintf('\n=== Diagonal |V_out/V_in| (mV/V): new (2.572) vs old (4.572) ===\n');
fprintf('  Pole   new (2.572)     old (4.572)         delta %% (abs)\n');
...
mat_path = fullfile(data_dir, 'Vout_Vin_2p572.mat');
...
tex_file = fullfile(tex_dir, 'Vout_Vin_2p572.tex');

fid = fopen(tex_file, 'w');
oc  = onCleanup(@() fclose(fid));

fprintf(fid, '%% Auto-generated by magnetic_sim/ANSYS/main/matlab/long2016_hexapole_halfcut/fit/gen_Vout_Vin_2p572.m\n');
fprintf(fid, '%% Sensor placement: 2.572 mm along surface, 0.41 mm normal\n');
