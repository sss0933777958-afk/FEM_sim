%% gen_Vout_Vin_3p472.m
%  ------------------------------------------------------------------
%  Compute V_out/V_in 6x6 matrix using sensor placement at 3.472 mm
%  (sensor variant: see also gen_Vout_Vin_{4p472,2p286}.m).
%
...
%
%  Sensor placement (changed: 4.572 -> 3.472 mm):
%      LOWER (P1/P3/P6): pole-local (3.472, 0.41, 0) mm relative to tip
%      UPPER (P2/P4/P5): pole-local decomposition of
%                          3.472 along cone slant + 0.41 outward normal
%                          axial      = 3.472*cos(beta) - 0.41*sin(beta) = 3.3249
%                          transverse = 3.472*sin(beta) + 0.41*cos(beta) = 1.0834
%
...
%
%  Outputs:
%    magnetic_sim/ANSYS/main/matlab/long2016_hexapole_halfcut/bs_matrix/data/Vout_Vin_3p472.mat
%    magnetic_sim/ANSYS/main/doc/Solve_B_matrix/long2016_hexapole_halfcut/scripts/Vout_Vin_3p472.tex
%  ------------------------------------------------------------------
...
%% --- Sensor placement: 3.472 mm (CHANGED) ---
S_ALONG  = 3.472e-3;                            % CHANGED: 4.572 -> 3.472
S_OFFSET = 0.41e-3;
...
fprintf('\n=== Diagonal |V_out/V_in| (mV/V): new (3.472) vs old (4.572) ===\n');
fprintf('  Pole   new (3.472)     old (4.572)         delta %% (abs)\n');
...
mat_path = fullfile(data_dir, 'Vout_Vin_3p472.mat');
...
tex_file = fullfile(tex_dir, 'Vout_Vin_3p472.tex');

fid = fopen(tex_file, 'w');
oc  = onCleanup(@() fclose(fid));

fprintf(fid, '%% Auto-generated by magnetic_sim/ANSYS/main/matlab/long2016_hexapole_halfcut/fit/gen_Vout_Vin_3p472.m\n');
fprintf(fid, '%% Sensor placement: 3.472 mm along surface, 0.41 mm normal\n');
