...
%  ⚠ NTU 模板（結構鏡像 long2016，函式同名）：待 NTU FEM 場（ANSYS_data/NTU_hexapole/data）與 NTU 專屬 mt_constants 齊備後可跑；目前只擺結構、不執行。
...
TREE = ['G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\matlab\' ...
        'NTU_hexapole\Calibration_using_FEM_modeling\current_base'];
