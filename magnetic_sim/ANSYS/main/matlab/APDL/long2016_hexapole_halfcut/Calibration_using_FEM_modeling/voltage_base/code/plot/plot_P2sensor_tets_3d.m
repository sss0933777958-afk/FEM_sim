...
%   PREVIEW=true → 暫存 png；false → 存 figures/。
    ...
    dref = import_ansys_data(fullfile(rr,'sensor_spheres','coil1'),'all','coil1');
    c = sp(:,2); ni = sn(:,2);
    ...
    if PREVIEW
        ...
        out = ['G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\matlab\' ...
               'long2016_hexapole_halfcut\Calibration_using_FEM_modeling\voltage_base\figures\shared\P2sensor_tets_3d.png'];
    end
