...
%   make_scaled_coil1(2,'standard_2A')  -> data/standard_2A/coil1 (B x2)
%   make_scaled_coil1(3,'standard_3A')  -> data/standard_3A/coil1 (B x3)
...
%   so import_ansys_data() reads it back identically.
    ...
    data_root = 'G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\ANSYS_data\long2016_hexapole_halfcut\data';
    src = fullfile(data_root,'standard','coil1');   % [MODIFIED] variant/coilN layout
    dst = fullfile(data_root,outname,'coil1');
