...
%
%  輸入：current_base/data/fit_fixl_R150um_gap200um_mueq.mat（gB=^Bĝ_I、Khat=K̄；ell 中心點不用）。
%  輸出：console（actuator 框 U/Σ/Wᵀ/T/σ/κ/指標）+ current_base/data/svd_SiHI_WP_gap200um_mueq.mat。
% =========================================================================

clear; clc;

%% ---- config ----------------------------------------------------------------
VARIANT = 'gap_200um';       % 校正變體（gap200 2 段式 μ_eff）
