...
%  ===========================================================================
d1   = import_ansys_data(ansys_path(model,'data','standard','coil1'), dataset, 'coil1');     % coil1 全網格(x,y,z,bx,by,bz)
...
for j = 1:N_I                                                % 逐一掃 6 個單線圈模擬
    if j == 1                                                % coil1 已載 → 重用
        ...
        dj = import_ansys_data(ansys_path(model,'data','standard',cn), dataset, cn);          % 載 coil j 全網格
