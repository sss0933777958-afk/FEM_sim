...
SD = load(['G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\matlab\long2016_hexapole_halfcut\' ...
           'Calibration_using_FEM_modeling\voltage_base\data\calib_sensor_d.mat']);  % 規則#2：voltage_base/data/
...
C = struct('P',{},'Bn',{});
for k=1:6
    da = import_ansys_data(fullfile(results_root, 'standard', sprintf('coil%d',k)),'wp',sprintf('coil%d',k));
