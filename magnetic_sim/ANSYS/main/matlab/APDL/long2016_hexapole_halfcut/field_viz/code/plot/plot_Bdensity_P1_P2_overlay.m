...
% "x or s [mm]".
    ...
    res_root = 'G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\ANSYS_data\long2016_hexapole_halfcut\data';
    ...
    %% =================== P1 <B_x>(x) ===================
    fprintf('--- P1 (coil1) ---\n');
    d1 = import_ansys_data(fullfile(res_root, 'standard', 'coil1'), 'all', 'coil1');
    ...
    %% =================== P2 <B_axial>(s) ===================
    fprintf('--- P2 (coil5) ---\n');
    d2 = import_ansys_data(fullfile(res_root, 'standard', 'coil5'), 'all', 'coil5');
