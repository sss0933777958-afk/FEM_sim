...
%   x_local = along pole axis (matches Φ x-axis exactly)
    ...
    %% ===== P1 =====
    res_dir_p1 = 'G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\ANSYS_data\long2016_hexapole_halfcut\data\standard\coil1';
    pole_axis_p1 = [1; 0; 0];
    up_hat_p1    = [0; 0; 1];
    ...
    res_dir_p2 = 'G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\ANSYS_data\long2016_hexapole_halfcut\data\standard\coil5';
