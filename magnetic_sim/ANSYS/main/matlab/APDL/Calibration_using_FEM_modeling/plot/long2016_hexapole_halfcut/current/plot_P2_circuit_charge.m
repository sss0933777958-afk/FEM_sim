...
% PLOT_P2_CIRCUIT_CHARGE(showArrows, Rum)   [current_base / 18-param bias]
...
%   upper (raw FEM already source) so KEEP sign (B=+B_FEM) -> arrows radiate OUT of tip.
    ...
    cnst = mt_constants();
    res_dir = 'G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\ANSYS_data\long2016_hexapole_halfcut\data\standard\coil5';   % P2
