...
%     current_base/code/function : load_coils_actuator(+variant), select_ball, fit_bias, make_Pc, build_A
...
%% ---- config ----------------------------------------------------------------
VARIANT  = 'gap_200um';   % FEM 變體：gap200 2 段式 μ_eff（graded mesh）
...
A   = build_S_matrix(ell_hat, Pc, P);     % [沿用] 3Np×6 stacked S_matrix（同交錯堆疊）
