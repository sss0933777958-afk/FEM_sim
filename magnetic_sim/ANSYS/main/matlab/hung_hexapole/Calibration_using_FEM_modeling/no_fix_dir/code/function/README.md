...
**內容**：
- （`write_KbarI_tex.m` 已於 2026-07-10 刪＝legacy；結果改由 `../main_function/emit_model_results.m` 產）

**資料來源 / 流向**：`load_coils_actuator` 讀 `ANSYS_data/.dat` → fit/gauge/誤差 → `../main_function/emit_model_results.m` 產 results PDF。
