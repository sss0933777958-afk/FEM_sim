...
%% ---- paths -----------------------------------------------------------------
% [MODIFIED] hung 版：TREE/results_root 指 hung；mt_constants/import_ansys_data 用 hung backup core
TREE = ['G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\matlab\' ...
        'hung_hexapole\Calibration_using_FEM_modeling\fix_dir'];
addpath('G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\backup\hexapole-long2016\analysis'); % filter_iron_nodes (hung core 無)
addpath('G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\backup\hung\analysis\core');          % [ADDED] hung mt_constants + import_ansys_data (後 addpath 優先)
...
results_root = 'G:\my_workspace\code\FEM_sim\magnetic_sim\ANSYS\main\ANSYS_data\hung_hexapole\data';  % [MODIFIED] hung 場資料
...
cnst = mt_constants();
apdl_to_paper_idx = cnst.apdl_to_paper_idx;             % [MODIFIED] hung = 恆等 [1,2,3,4,5,6]（coil k excites paper Pk）
