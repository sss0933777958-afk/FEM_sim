...
% 參數對齊 main_Vmat.m：VARIANT='gap_200um'、S_hall=130、n_uniform=100、graded csv、
...
addpath(fullfile(CAL,'Hall_sensor_base_fix_dir','code','main_function'));                            % build_sensor_geometry
