...
% =========================================================================
%  把 current_base（fix-l 點電荷）與 current_base（18-param bias）兩模型 vs FEM（gap200）的
...
%  本副本輸出到 current_base/figures/（current_base/code/plot 有同檔輸出到 current_base/figures/）。
% =========================================================================
...
OUT_PNG   = fullfile(CAL,'current_base','figures','shared', 'fix_vs_nofix_err_hist.png');   % <== 本副本輸出位置
