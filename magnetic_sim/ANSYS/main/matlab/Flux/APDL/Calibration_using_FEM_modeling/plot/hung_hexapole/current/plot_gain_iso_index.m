...
%   輸出：current_base/figures/{gain,iso}_index_R500um.png（棕、135 bins、N/mean/CV 框、紅虛線=mean）。
    ...
    %% ---- 直方圖 ----
    figdir = fullfile(fixdir,'figures','shared');  if ~exist(figdir,'dir'); mkdir(figdir); end
