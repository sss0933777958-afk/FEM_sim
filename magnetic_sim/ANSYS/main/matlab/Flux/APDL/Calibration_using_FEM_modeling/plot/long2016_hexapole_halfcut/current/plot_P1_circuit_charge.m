...
% PLOT_P1_CIRCUIT_CHARGE(mode, showArrows, Rum)   [current_base / 18-param bias]
...
%   This differs from current_base (on-axis ell*dhat).  Field arrows + geometry are identical
%   to current_base (same coil1 FEM, all-source B=-B_FEM for the lower pole -> tip radiates).
