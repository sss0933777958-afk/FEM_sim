...
| dir | 極（方位/層） | WP 中心 \|B\| | 檔案（每夾 4 個 .dat） |
|---|---|---|---|
| `data/coil1/` | P1（0°/下） | **5.88 mT** | coil1_{coord,bfield}_{all,wp}.dat |
| `data/coil2/` | P2（180°/上） | **7.53 mT** | coil2_… |
| `data/coil3/` | P3（120°/下） | **5.89 mT** | coil3_… |
| `data/coil4/` | P4（300°/上） | **7.50 mT** | coil4_… |
| `data/coil5/` | P5（60°/上） | **7.50 mT** | coil5_… |
| `data/coil6/` | P6（240°/下） | **5.95 mT** | coil6_… |
...
## 讀取注意
- 只有 `gap_200um` 一個 case（無 baseline），`data/coilN/` 直接是它。
