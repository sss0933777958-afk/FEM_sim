...
**命名 / 慣例**：`general`（小寫、不加底線）為 schema 唯一例外 —— 真正跨變體 / 純理論文件才放這；直接放 .md，不分 scripts/pdf 葉夾。
**相關**：各模型實際擬合結果見 ../long2016_hexapole_*、../kuo_quadrupole；推導見 ../fitting_derivation/；見 ../README.md、../../../CLAUDE.md。
