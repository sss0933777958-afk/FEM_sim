...
**資料來源 / 流向**：由 `../SLDPRT/` 匯出 → 抽參數（`reference/workflows/step-to-apdl.md`）/ 產 IGES / COMSOL import。
...
**相關**：`../README.md`、`ansys-cad-alignment.md`、`reference/workflows/step-to-apdl.md`、COMSOL 流程 `reference/workflows/comsol-livelink.md`。
