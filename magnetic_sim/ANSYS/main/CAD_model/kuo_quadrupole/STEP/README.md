...
**資料來源 / 流向**：由 `../SLDPRT/` 母檔匯出而來 → 供 `reference/workflows/step-to-apdl.md` 抽參數寫 `apdl/kuo_quadrupole/geom/<variant>_params.md`，並產 IGES。
...
**相關**：`../README.md`、`ansys-cad-alignment.md`、`reference/workflows/step-to-apdl.md`。
